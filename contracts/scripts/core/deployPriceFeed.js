...
async function getArbValues() {
  ...
  const priceFeedTimelock = {
    address: "0xe78f1F865C60780D0f51B94F6c8DD8012603A200",
  };
...
async function getAvaxValues() {
  ...
  const priceFeedTimelock = {
    address: "0x1273bD9042914386Adf8C7035AE1C49f787B1534",
  };

  const updater1 = { address: "0x192772028874Ff75E2f7332Ce10cB0A475BF7f00" };
  const updater2 = { address: "0x192772028874Ff75E2f7332Ce10cB0A475BF7f00" };
  const keeper1 = { address: "0x192772028874Ff75E2f7332Ce10cB0A475BF7f00" };
  const keeper2 = { address: "0x192772028874Ff75E2f7332Ce10cB0A475BF7f00" };
  const updaters = [
    updater1.address,
    updater2.address,
    keeper1.address,
  ...
  const positionRouter = await contractAt(
    "PositionRouter",
    "0xA8A8ef28cE7cDC25319f0E13fD8245F26caf8849"
  );
...
async function main() {
  ...
  const deployer = { address: "0x192772028874Ff75E2f7332Ce10cB0A475BF7f00" };
  ...
  const signers = [
    "0x192772028874Ff75E2f7332Ce10cB0A475BF7f00", // coinflipcanada
  ];
  ...
  const vaultPriceFeed = await contractAt(
    "VaultPriceFeed",
    "0x02a8255E8fa854A2E09be21aC7A77272d9BB8547"
  );
