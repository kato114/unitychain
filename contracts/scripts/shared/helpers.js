...
const { POLYGON_URL, POLYGON_DEPLOY_KEY } = require("../../env.json");

const providers = {
  polygon: new ethers.providers.JsonRpcProvider(POLYGON_URL),
};

const signers = {
  polygon: new ethers.Wallet(POLYGON_DEPLOY_KEY).connect(providers.polygon),
};
