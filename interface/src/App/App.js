...
import BuyUNITY from "pages/BuyUNITY/BuyUNITY";
import Buy from "pages/Buy/Buy";
import Bridge from "pages/Bridge/Bridge";
import NftWallet from "pages/NftWallet/NftWallet";
import ClaimEsUnity from "pages/ClaimEsUnity/ClaimEsUnity";
...
import { ARBITRUM, getAlchemyWsUrl, getExplorerUrl } from "config/chains"; //BSC, POLYGON, OPTIMISM,
    ...
    if (!hasMetaMaskWalletExtension()) {
      helperToast.error(
        <div>
          ...
          {userOnMobileDevice ? (
            <Trans>
              <ExternalLink href="https://metamask.io">Install MetaMask</ExternalLink>, and use $UNITY with its built-in
              browser
            </Trans>
          ) : (
            <Trans>
              <ExternalLink href="https://metamask.io">Install MetaMask</ExternalLink> to start using $UNITY
            </Trans>
          )}
        </div>
      );
    ...
    if (!hasCoinBaseWalletExtension()) {
      helperToast.error(
        <div>
          ...
          {userOnMobileDevice ? (
            <Trans>
              <ExternalLink href="https://www.coinbase.com/wallet">Install Coinbase Wallet</ExternalLink>, and use UNITY
        ...
        <div className="App-content">
          ...
          <div className="App-container">
            ...
            <Switch>
              ...
              <Route exact path="/claim_es_unity">
                <ClaimEsUnity setPendingTxns={setPendingTxns} />
              </Route>
