...
export default function ExchangeTVChart(props) {
  ...
  const currentAveragePrice = null;
      ...
      <div className="ExchangeChart-top App-box App-box-border">
        <div className="ExchangeChart-top-inner">
          <div>
            ...
            <div className="ExchangeChart-info-label text-lightgreen">
          ...
          <div>
            ...
            <div className={`{cx({ positive: deltaPercentage > 0, negative: deltaPercentage < 0 })} text-lightgreen`}>
              {!deltaPercentageStr && "-"}
