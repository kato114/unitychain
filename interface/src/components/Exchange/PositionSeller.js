...
function shouldSwap(collateralToken, receiveToken) {
  ...
  // @see https://github.com/UnityChain-Dex/unity-interface/blob/master/src/pages/Exchange/Exchange.js#L162
...
export default function PositionSeller(props) {
  ...
  const getError = () => {
    ...
    if (nextLeverage && nextLeverage.gt(100.5 * BASIS_POINTS_DIVISOR)) {
      return t`Max leverage: 100.5xt`;
    }
        ...
        return (
          <div className="Confirmation-box-warning">
            <Trans>
              ...
              <ExternalLink href="https://docs.utrade.exchange/trading#minimum-price-change">
                pending profit
              </ExternalLink>{" "}
              of {deltaStr}. <br />
            </Trans>
      ...
      return (
        <div className="Confirmation-box-warning">
          <Trans>
            ...
            <ExternalLink href="https://docs.utrade.exchange/trading#minimum-price-change">profit</ExternalLink> of{" "}
            {deltaStr}. <br />
          </Trans>
          <Trans>
            Profit price: {position.isLong ? ">" : "<"} ${formatAmount(profitPrice, USD_DECIMALS, 2, true)}. This rule
                  ...
                  renderContent={() => (
                    <div>
                      ...
                      <div className="PositionSeller-fee-item">
                        <Trans>
                          <ExternalLink href="https://docs.utrade.exchange/trading#fees">More Info</ExternalLink> about
                          fees.
                        </Trans>
                      </div>
                    </div>
