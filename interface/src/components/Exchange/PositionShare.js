...
import unityLogo from "img/unity-logo-with-name.svg";
...
function PositionShare({ setIsPositionShareModalOpen, isPositionShareModalOpen, positionToShare, account, chainId }) {
  ...
  const tweetLink = getTwitterIntentURL(
    `Latest $${positionToShare?.indexToken?.symbol} trade on @unitychain`,
  ...
  return (
    <div className="relative">
      <div ref={positionRef} className="position-share" style={{ backgroundImage: `url(${sharePositionBgImg})` }}>
        <img className="logo" src={unityLogo} alt="UNITY Logo" />
        <ul className="info">
        ...
        <div className="referral-code">
          ...
          <div className="referral-code-info">
            {success && code ? (
              ...
              <p className="code">https://app.utrade.exchange</p>
            )}
          </div>
        </div>
      </div>
