...
export default function SwapBox(props) {
  ...
  const getLeaderboardLink = () => {
    // if (chainId === BSC) {
    //   return "https://www.unity.house/bsc/leaderboard";
    // }
    // if (chainId === POLYGON) {
    //   return "https://www.unity.house/polygon/leaderboard";
    // }
    // if (chainId === OPTIMISM) {
    //   return "https://www.unity.house/optimism/leaderboard";
    // }
    if (chainId === ARBITRUM) {
      return "https://www.unity.house/arbitrum/leaderboard";
    }
    return "https://www.unity.house";
  };
  ...
  const getLeverageError = () => {
    ...
    if (leverage && leverage.gt(100.5 * BASIS_POINTS_DIVISOR)) {
      return [t`Max leverage: 100.5x`];
    }
  ...
  const increasePosition = async () => {
    ...
    callContract(chainId, contract, method, params, {
      ...
      hideSuccessMsg: false, //chainId === BSC,
    })
      .then(async () => {
        setIsConfirming(false);
        ...
        {isStopOrder && (
          <div className="Exchange-swap-section Exchange-trigger-order-info">
            <Trans>
              ...
              <ExternalLink href="https://docs.utrade.exchange/trading#stop-loss-take-profit-orders">docs</ExternalLink>
              .
            </Trans>
          </div>
        )}
                  ...
                  return (
                    <div>
                      <Trans>
                        ...
                        <br />
                        <br />
                        <ExternalLink href="https://docs.utrade.exchange/trading#opening-a-position">
                          More Info
                        </ExternalLink>
                      </Trans>
                    </div>
      ...
      <div className="Exchange-swap-market-box App-box App-box-border">
        ...
        <div className="Exchange-info-row">
          <div className="Exchange-info-label-button">
            <ExternalLink href="https://docs.utrade.exchange/trading">
        ...
        <div className="Exchange-info-row">
          <div className="Exchange-info-label-button">
            <ExternalLink href="https://docs.utrade.exchange/trading#backup-rpc-urls">
