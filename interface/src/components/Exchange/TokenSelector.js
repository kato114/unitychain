    ...
    <div className={cx("TokenSelector", { disabled }, props.className)}>
              ...
              >
                ...
                <div className="Token-info">
                  {showTokenImgInDropdown && (
                    <img src={tokenImage} alt={token.name} className="token-logo" width="40px" />
                  )}
      ...
      {selectedTokenLabel ? (
        ...
        <div className="TokenSelector-box" onClick={() => setIsModalVisible(true)}>
          {tokenInfo.symbol}
          {showSymbolImage && (
            <img src={tokenImage} alt={tokenInfo.symbol} className="TokenSelector-box-symbol" width="24px" />
          )}
