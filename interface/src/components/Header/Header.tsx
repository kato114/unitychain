...
import logoSmallImg from "img/logo_UNITY_small.png";
          ...
          <div>
            <div className="App-header-container-left">
              <Link className="App-header-link-main" to="/">
                <img src={logoImg} className="big" alt="UNITY Logo" />
                <img src={logoSmallImg} className="small" alt="UNITY Logo" />
              </Link>
            </div>
          ...
          >
            <div className="App-header-container-left">
              <div className="App-header-menu-icon-block" onClick={() => setIsDrawerVisible(!isDrawerVisible)}>
                {!isDrawerVisible && <RiMenuLine className="App-header-menu-icon" fill="white" />}
                {isDrawerVisible && <FaTimes className="App-header-menu-icon" fill="white" />}
              </div>
