...
import bscIcon from "img/ic_bsc_24.svg";
import maticIcon from "img/ic_polygon_24.svg";
import optimismIcon from "img/ic_optimism_24.svg";
    ...
    <>
      <button className={cx("secondary-btn")}>
        <img
          ...
          width="24px"
        />
        <span style={{ paddingLeft: "5px" }}>{selectorLabel}</span>
      </button>
    </>
  );
}
