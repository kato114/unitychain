...
function AffiliatesStats({
  ...
  return (
    <div className="referral-body-container py-30">
                                ...
                                renderContent={() => (
                                  <div>
                                    <Trans>
                                      ...
                                      {chainId === POLYGON ? "Bsc" : "Polygon"}, you will not receive rebates
                                      there.
                                      <br />
                                      <br />
                                      Switch your network to create this code on{" "}
                                      {chainId === POLYGON ? "Bsc" : "Polygon"}.
                                    </Trans>
                                  </div>
                                )}
                              />
                                ...
                                renderContent={() => (
                                  <div>
                                    <Trans>
                                      ...
                                      {chainId === POLYGON ? "Bsc" : "Polygon"}, you will not receive rebates
                                      from traders using this code on {chainId === POLYGON ? "Bsc" : "Polygon"}
                                      .
                                    </Trans>
                                  </div>
                                )}
