        ...
        failMsg = (
          <div>
            <Trans>
              ...
              <br />
              <br />
              <ExternalLink href="https://bsc.io/bridge-tutorial/">Bridge ETH to Bsc</ExternalLink>
            </Trans>
          </div>
        );
        break;
        ...
        failMsg = (
          <div>
            <Trans>
              ...
              <ExternalLink href="https://docs.utrade.exchange/trading#backup-rpc-urls">More info</ExternalLink>
            </Trans>
            <br />
