...
export const Exchange = forwardRef((props, ref) => {
  ...
  useEffect(() => {
    fromToken = getTokenInfo(infoTokens, fromTokenAddress);
    toToken = getTokenInfo(infoTokens, toTokenAddress);
      ...
      <div className="section-title-block">
        ...
        <div className="section-title-content">
          ...
          <div className="Page-description">
            <Trans>Trade tokens and make profit</Trans>
          </div>
        </div>
      </div>
      <div className="Exchange-content py-30">
