      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            ...
            <div className="Page-title">$UNITY Referral Program</div>
          ...
          <div className="content">
            <div className="section">
              ...
              <p className="body-text">
                ...
                Affiliate"), explains the terms and conditions by which you may use the $UNITY Referral Program
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program allows you to advertise the $UNITY DApp, thereby driving traffic to it, whereby you
                may earn a portion of the fees generated ("Rebates") if a person that is not you ("Trader," "Referred
                User") trades in the $UNITY DApp after being referred to it from a hyperlink ("Link") or manually input
                code ("Referral Code"). The Trader will benefit from a fee discount ("Discount") associated with the
                Referrer's tier.
              </p>
              <p className="body-text">
                After being referred to the $UNITY DApp from a Link, the Trader's browser will save your Referral Code,
            ...
            <div className="section">
              ...
              <p className="body-text">
                2.1 As an Affiliate, $UNITY DApp provides you with the Links and Referral Codes necessary to promote the
                $UNITY Protocol. You acknowledge and agree it is your sole responsibility to indicate your correct
                Referral Code. You may promote the $UNITY Protocol offers in any manner you choose unless it misleads
                someone about the $UNITY Protocol.
              </p>
              <p className="body-text">
                2.2 utrade.exchange is not responsible for (i) lost sales or lost opportunity to earn Rebates due to any
                cause, such as technical difficulties or over-capacity, including system overload in the Polygon, BSC,
                Optimism or Arbitrum blockchains; (ii) tracking Rebates, Discounts, or any other data, as this is
                handled by independent, smart contracts.
              </p>
              <p className="body-text">
                2.3 You will be excluded from the Referral Program, following the directives of the $UNITY tokenholders:
            ...
            <div className="section">
              ...
              <p className="body-text">
                utrade.exchange is under no obligation for Rebates or Discounts to any Referrer or Trader. Rebates and
                Discounts are handled following the directives of the $UNITY tokenholders.
              </p>
              <p className="body-text">
                ...
                <a target="_blank" rel="noopener noreferrer" href="https://docs.utrade.exchange/how-it-works/referrals">
                  https://docs.utrade.exchange/how-it-works/referrals.
                </a>
              </p>
            </div>
            <div className="section">
              ...
              <p className="body-text">
                Under no circumstances shall utrade.exchange be liable for any direct, indirect, incidental, punitive,
              ...
              <p className="body-text">
                In no event shall utrade.exchange's aggregate liability arising out of or in connection with the Site
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                service(s) provided by utrade.exchange, or your use of the service(s) provided by utrade.exchange,
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program runs independently from utrade.exchange, which the token holders of $UNITY
              ...
              <p className="body-text">
                utrade.exchange will not be liable for any losses suffered by you resulting from any modification to the
              ...
              <p className="body-text">
                utrade.exchange may revise these Terms from time to time. We will notify you by updating the date at the
                top of the Terms and maintaining a current version. The most current version of the Terms will always be
                at https://app.utrade.exchange/#/referral-terms. All modifications will be effective when they are
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                only agreement between you and utrade.exchange concerning the subject matter of these Terms and
              ...
              <p className="body-text">
                ...
                unenforceable or invalid as a whole. utrade.exchange will amend or replace such provision with one that
              ...
              <p className="body-text">
                ...
                or in connection with any change of control. utrade.exchange may assign or transfer any or all of our
                rights or obligations under these Terms, in whole or part, without notice or obtaining your consent or
                approval.
              </p>
              <p className="body-text">
                8.6 utrade.exchange will have no responsibility or liability for any failure or delay in performance of
