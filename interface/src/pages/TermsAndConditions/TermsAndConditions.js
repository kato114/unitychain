...
import UnityLogo from "../../img/level_symbol.png";
      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            ...
            <div className="Page-title">$UNITY</div>
            <div className="Page-subtitle">Terms and Conditions</div>
            <div className="Page-description text-blue">Last modified: November 1st, 2022</div>
          </div>
          <div className="content">
            <div className="section">
              <p className="body-text">
                Welcome to utrade.exchange ("we," "us," or "our"), the informational resource for $UNITY Protocol, as
                defined below.
              </p>
              <p className="body-text">
                utrade.exchange provides information and resources about the fundamentals of the decentralized
                non-custodial protocol called the $UNITY Protocol (the "$UNITY Protocol," "Protocol," or "$UNITY DApp").
                utrade.exchange is not an available access point to the $UNITY Protocol.
              </p>
              <p className="body-text">
                ...
                and conditions by which you may access utrade.exchange ("the Site") and app.utrade.exchange ("the
            ...
            <div className="section">
              ...
              <p className="body-text">The utrade.exchange site is for informational purposes only.</p>
              <p className="body-text">
                utrade.exchange is not part of any transaction on the blockchain networks underlying the $UNITY
                ...
                store, send, or receive any crypto assets. You understand that when you interact with any $UNITY
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        administrative authority having jurisdiction over utrade.exchange or you as otherwise duly
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        ...
                        procedures or repairs that utrade.exchange or any of its suppliers or contractors may undertake
                        from time to time; (c) causes beyond utrade.exchange's control or that utrade.exchange could not
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        transaction with utrade.exchange;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">1.2.5. utrade.exchange does not act as a broker or advisor for you;</p>
                    </li>
                    <li>
                      <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                fees. utrade.exchange does not receive fees for any blockchain transactions or using the Site or the
                Interface.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    4.1. utrade.exchange own all rights, names, logos, and other marks used on the Site and the
                    ...
                    the $UNITY Protocol and the Interface (utrade.exchange) deployed on IPFS is open-sourced. Except as
                ...
                <li>
                  <p className="body-text">
                    4.2. utrade.exchange may use and share your comments, bug reports, ideas, or other feedback that you
                    may provide, including suggestions about how we might improve. You agree that utrade.exchange is
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    5.1. utrade.exchange reserve the right, at our sole discretion, from time to time and with or
                    ...
                    do not host or own its code. utrade.exchange will not be liable for any losses suffered by you
                ...
                <li>
                  <p className="body-text">
                    5.2. utrade.exchange may revise these Terms from time to time. We will notify you by updating the
                    date at the top of the Terms and maintaining a current version. The most current version of the
                    Terms will always be at https://app.utrade.exchange/#/terms-and-conditions. All modifications will
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    ...
                    others, entails a risk that by accessing transactions, you are assuming. utrade.exchange does not
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        6.1.1. That utrade.exchange is not responsible for the operation of the open-source software and
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        blockchain-based network. Neither utrade.exchange nor any other person or entity will be able to
                ...
                <li>
                  <p className="body-text">
                    6.2. utrade.exchange is not responsible for the content of any third party, including, but not
                    limited to, information, materials, products, or services that utrade.exchange does not own or
                    control. In addition, third parties may offer promotions related to your access and use of the
                    Interface. utrade.exchange does not endorse or assume any responsibility for such resources or
                    ...
                    relationships with any third parties. You expressly relieve utrade.exchange of all liability arising
                    from using such resources or participating in such promotions.
                  </p>
                </li>
                <li>
                  <p className="body-text">
                    6.3. You understand that the Polygon, BSC, Optimism and Arbitrum blockchain remains under
                    development, which creates technological and security risks when using the Interface, in addition to
                    uncertainty relating to digital assets and transactions therein. You acknowledge that the cost of
                    transacting on the Polygon, BSC, Optimism and Arbitrum blockchain is variable and may increase at
                    any time, causing an impact on any activities taking place on these blockchains, which may result in
                ...
                <li>
                  <p className="body-text">
                    6.6. You hereby assume and agree that utrade.exchange will have no responsibility or liability for
                    the risks in Section 9. You hereby irrevocably waive, release and discharge all claims, whether
                    known or unknown to you, against utrade.exchange, its affiliates, and their respective shareholders,
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        right of publicity, privacy, or any other proprietary right of utrade.exchange;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
                    ...
                    <li>
                      <p className="body-text">
                        7.1.6. Harass, abuse, or harm another person or entity, including utrade.exchange's collaborator
            ...
            <div className="section">
              ...
              <p className="body-text">
                utrade.exchange is an informational site for the $UNITY Protocol. utrade.exchange does not operate an
              ...
              <p className="body-text">
                You understand that utrade.exchange is not registered or licensed by any regulatory agency or authority.
              ...
              <p className="body-text">
                ...
                utrade.exchange makes no guarantees of any kind or connection with the Site or the Interface.
              </p>
            </div>
            <div className="section">
              <h3 className="body-title">9. LIMITATION OF LIABILITY</h3>
              <p className="body-text">
                In no event shall utrade.exchange, its affiliates, its suppliers and contractors, and its affiliates',
                ...
                or the Interface, or other item provided by or on behalf of utrade.exchange, whether under contract,
                ...
                Terms or any limited remedy hereunder nor is utrade.exchange in any way responsible for the execution or
                settlement of transactions between users of the Interface.
              </p>
              <p className="body-text">
                In no event shall utrade.exchange's aggregate liability arising out of or in connection with the Site or
            ...
            <div className="section">
              ...
              <p className="body-text">
                You will defend, indemnify, and hold harmless utrade.exchange, its affiliates, members, member,
            ...
            <div className="section">
              ...
              <p className="body-text">
                utrade.exchange will use its best efforts to resolve potential disputes through informal, good faith
                negotiations. If a potential dispute arises, you must contact us by sending a written notice of your
                claim ("Notice") to utrade.exchange on any of our official channels. The notice must (a) describe the
                nature and basis of the claim and (b) set forth the specific relief sought. Our notice to you will be
                similar in form to that described above. If you and utrade.exchange cannot reach an agreement to resolve
                the claim within sixty (60) days of your email, then you and utrade.exchange agree to resolve the
              ...
              <p className="body-text">
                ...
                utrade.exchange will not have the right to assert the claim.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    13.1. Any right or remedy of utrade.exchange set forth in these Terms is in addition to, and not in
                    lieu of, any other right or remedy whether described in these Terms, under Applicable Law, at law,
                    or in equity. The failure or delay of utrade.exchange in exercising any right, power, or privilege
                ...
                <li>
                  <p className="body-text">
                    13.4. utrade.exchange will have no responsibility or liability for any failure or delay in
                ...
                <li>
                  <p className="body-text">
                    13.6. These Terms contain the entire agreement between you and utrade.exchange and supersede all
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                utrade.exchange on any of our official channels.
              </p>
            </div>
          </div>
        </div>
