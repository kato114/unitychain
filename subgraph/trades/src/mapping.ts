...
import {
  ...
  AddLiquidity,
  RemoveLiquidity,
} from "../generated/UlpManager/UlpManager";

// import {
//   Distribute
// } from "../generated/FeeUnityRewardDistributor/RewardDistributor"
...
const LIQUIDATOR_ADDRESS = "0x0524af1B20a7F1c02A06CB73c8Ee15030B39F10e";
...
export function handleIncreaseReservedAmount(
  ...
  totalEntity.reservedAmount = totalEntity.reservedAmount.plus(
    event.params.amount
  );
...
export function handleDecreaseReservedAmount(
  ...
  totalEntity.reservedAmount = totalEntity.reservedAmount.minus(
    event.params.amount
  );
  totalEntity.reservedAmountUsd = getTokenAmountUsd(
    token.toHexString(),
